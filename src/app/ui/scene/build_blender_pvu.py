...
if __name__ == "__main__":
    ...
    print(f"Exported GLB to: {out_glb}")"""Build a complex apartment PVU scene in Blender and export it as GLB.

This script is intended to run inside Blender:

    blender.exe --background --python src/app/ui/scene/build_blender_pvu.py
